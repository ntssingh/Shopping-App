const styles = {
    ...
    productDiscountPrice:"font-bold text-[1 rem] text-[#333] font-Roboto",
    price:"font-[500] text-[1 rem] text-[#d55b45] pl-3 mt-[-4px] line-through",
    shop_name:"pt-3 text-[15px] text-blue-400 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
    button: 'w-[150px] bg-[#010203] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    ...
    login_button: 'w-[80px] bg-[#010203] h-[40px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
  };
